...
echo "\n";
        ...
        sleep(10);
         ...
         $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"KEJUTANGOMART"}');
...
echo "\n".color("green","👌🍱 Ambil Voucer ");
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI3GP"}');
...
echo "\n".color("green","👌🍱 Ambil Voucer ");
        ...
        $code1 = requested('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI3GP"}');
