...
// function change(){
        ...
        echo color("blue","📶▶️ Kode verifikasi sudah di kirim")."\n";
        otp:
	...
	$post = [
         ...
         setpin:
         echo "\n".color("blue","🔧▶️ SET PIN SEKLAIAN BIAR AMAN !!!: y/n ");
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("blue","!] Silahkan registrasi kembali\n");
         goto ulang;
         }
//  }
