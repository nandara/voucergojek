...
echo "\033[0m";
if($user == "nandara" || $user == "pieter" || $user == "martin" || $user == "imel" || $user == "21")
{
	echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
...
// function change(){
        ...
        echo "\n".color("orange","🔓▶️ Message: ".$message);
        goto gocar;
        }else{
	...
	gocar:
        ...
        echo "\n".color("orange","🔓▶️ Message: ".$messageboba09);
        sleep(3);
        ...
        echo "\n".color("orange","                     1. ".$voucher1);
        echo "\n".color("orange","                     2. ".$voucher2);
        echo "\n".color("orange","                     3. ".$voucher3);
        echo "\n".color("orange","                     4. ".$voucher4);
        echo "\n".color("orange","                     5. ".$voucher5);
        echo "\n".color("orange","                     6. ".$voucher6);
        echo "\n".color("orange","                     7. ".$voucher7);
        echo "\n".color("orange","                     8. ".$voucher8);
        echo "\n".color("orange","                     9. ".$voucher9);
        echo "\n".color("orange","                     10. ".$voucher10);
	echo "\n".color("orange","                     11. ".$voucher11);
        echo "\n".color("orange","                     12. ".$voucher12);
        echo "\n".color("orange","                     13. ".$voucher13);
        echo"\n";
